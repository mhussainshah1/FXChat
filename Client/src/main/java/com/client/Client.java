...
public class Client implements Serializable {
	 ...
	 * > java com.client.Client username
	 * > java com.client.Client username portNumber
	 * > java com.client.Client username portNumber serverAddress
	...
	public static void main(String[] args) {
		...
		switch (args.length) {
			case 3:
				// for > javac com.client.Client username portNumber serverAddr
				serverAddress = args[2];
			case 2:
				// for > javac com.client.Client username portNumber
				try {
					portNumber = Integer.parseInt(args[1]);
				} catch (Exception e) {
					System.out.println("Invalid port number.");
					System.out.println("Usage is: > java com.client.Client [username] [portNumber] [serverAddress]");
					return;
				}
			case 1:
				// for > javac com.client.Client username
				userName = args[0];
			case 0:
				// for > java com.client.Client
				break;
		...
		// create the com.client.Client object
		...
		// close resource
		scan.close();
		// com.client completed its job. disconnect com.client.
		client.disconnect();
	}
